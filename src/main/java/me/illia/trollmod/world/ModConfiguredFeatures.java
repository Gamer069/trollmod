...
public class ModConfiguredFeatures {
	public static final RegistryKey<ConfiguredFeature<?, ?>> PURPLEHEART_KEY = registerKey("purpleheart");

	public static void bootstrap(Registerable<ConfiguredFeature<?, ?>> context) {
		register(context, PURPLEHEART_KEY, Feature.TREE, new TreeFeatureConfig.Builder(
			BlockStateProvider.of(ModBlocks.PURPLEHEART_LOG),
			new StraightTrunkPlacer(4, 2, 3),
			BlockStateProvider.of(ModBlocks.PURPLEHEART_LEAVES),
	...
	public static RegistryKey<ConfiguredFeature<?, ?>> registerKey(String name) {
		return RegistryKey.of(RegistryKeys.CONFIGURED_FEATURE, Util.id(name));
	}
